...
public class UsuarioControllerTest {
	...
	public void deveListarApenasUmUsuario() {
		...
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L,
				"Laura Santolia", "laura_santoli@email.com.br", "laura12345", "https://i.imgur.com/EcJG8Kb.jpg"));
		ResponseEntity<String> resposta = testRestTemplate
		.withBasicAuth("root","root")
	...
	public void deveAutenticarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Marisa Souza", "marisa_souza@email.com.br", "12131313", "https://i.imgur.com/EcJG8Kb.jpg"));
		
		HttpEntity<UsuarioLogin> requisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L,
				"", "marisa_souza@email.com.br", "12131313", "", ""));
